...
| [Лекция 5. Решающие деревья](https://youtu.be/Tn6aCM9xOrE) | [Конспект 5](https://colab.research.google.com/drive/1CT_Y0kuM8tloOoamvYaP-OiPuory2fDn?usp=sharing) | [ДЗ 5](https://contest.yandex.ru/contest/42452/problems/) | [`20.11.2022, 23:59`](https://t.me/c/1799088970/114)| За *тестовое задание (№1-10)* при правильном ответе - **1 балл**. Задачи: P1. Параметры - 4 баллов; P2. Лучшая комбинация - 6 баллов. Максимально 20 баллов. Домашнее задание будет **засчитано** при выполнении от 65% (т.е. 13 баллов). **Сертификат** - при выполнении **от 90%** (т.е. 18 баллов)|
