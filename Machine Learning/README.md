...
Задачи:
P1. Параметры - 4 баллов
P2. Лучшая комбинация - 6 балла
Итого максимальное кол-во баллов = 20

✅ Домашнее задание будет засчитано при выполнении от 65% (т.е. 13 баллов)
📜 Для получения сертификата необходимо выполнить от 90% (т.е. 18 баллов)|
