...
| [Лекция 8. Задача понижения размерности](https://youtu.be/lt5nqAtqvOI) | [Конспект 8](https://colab.research.google.com/drive/1ldt1uUd8bJwiuUHrp2xmTKjELYVLcdzZ?usp=sharing) | [ДЗ 8](https://contest.yandex.ru/contest/43744/problems/)| [`11.12.2022, 23:59`]()| За *тестовое задание (№1-10)* при правильном ответе - **1 балл**. Задачи: *P1.Эффективная размерность* - **4 балла**; *P2.PCA* - **6 баллов**. Максимально 20 баллов. Домашнее задание будет **засчитано** при выполнении **от 65%** *(т.е. 13 баллов)*. **Сертификат** - при выполнении **от 90%** *(т.е. 18 баллов)*.|
| [Лекция 9. Задача кластеризации](https://youtu.be/bIkfbl2y8wY) | [Конспект 9](https://colab.research.google.com/drive/12UxgMBnwO5nnlPe9E8sEHItyzR_HRwkG#scrollTo=grCbogrt2qbB) | [ДЗ 9]()||||
