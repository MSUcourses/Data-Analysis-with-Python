...
|:----:|----|:----:|:----:|:----:|
|15.02.2023| Лекция 1. Вводная лекция. Знакомство с Python. 
Ввод и вывод информации | Конспект 1 |||
...
|29.03.2023| Лекция 6. Работа с текстовой информацией. 
Срезы строк и списков| Конспект 6 |||
