...
|:----:|----|----|:----:|:----:|
|| Лекция 1. Вводная лекция | Конспект 1 |||
|| Лекция 2. Текстовые данные | Конспект 2 |||
|| Лекция 3. Итерируемые объекты | Конспект 3 |||
|| Лекция 4. Числовые данные | Конспект 4 |||
|| Лекция 5. Сортировка данных | Конспект 5 |||
|| Лекция 6. Частотный анализ и группировка данных | Конспект 6 |||
|| Лекция 7. Библиотека Matplotlib | Конспект 7 |||
|| Лекция 8. Библиотека NumPy | Конспект 8 |||
|| Лекция 9. Логика, NumPy, библиотека Pandas | Конспект 9 |||
|| Лекция 10. Библиотека Pandas | Конспект 10 |||
