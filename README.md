...
Вы можете редактировать ваш блокнот совместно с другими пользователями, оставлять коментарии, предоставлять различные права доступа к документу, то есть работать точно также как и с любым документом на Google Drive. Но, помимо этого, есть некоторые особенности, которые лучше освоить перед началом работы.
...
3. __Аппаратный ускоритель__
   ...
   Для обычных задач (с которыми мы будем работать в курсе "Основы программирования и анализа данных на Python") смысла в использовании нет. Этот раздел пригодится вам в следующих курсах. 
