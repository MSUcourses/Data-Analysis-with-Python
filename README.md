...
![im_IDLE](https://user-images.githubusercontent.com/28728575/125690969-4ea4bc98-95ed-4bd2-8c1d-a3c51a0c4203.png)
...
- Напишите какой-нибудь код, например:
    ...
    print("Мне %d лет!" %age)
    ```
- Запустите файл (но перед этим сохраните) с помощью 
 
### PIP <a name="pip"></a>

Для полноценной работы с языком _Python_ вам необходимы библиотеки (далее пакеты), которые могут упросить написание 
